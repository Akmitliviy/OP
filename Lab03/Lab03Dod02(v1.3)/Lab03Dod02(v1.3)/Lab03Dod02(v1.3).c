...
int main(void) {
	int sum = 0;
	int a[N][N] = { {1, 7, 4, 0, 9, 4, 8, 8, 2, 4, 5, 5, 1, 7, 1},
	...
	int b[N][N] = { {0, 8, 8, 0, 6, 8, 1, 9, 8, 9, 7, 2, 2, 8, 2},
					{8, 9, 0, 7, 8, 1, 5, 8, 6, 1, 2, 4, 2, 5, 8},
					{6, 2, 6, 5, 3, 9, 2, 4, 6, 1, 8, 2, 1, 1, 9},
					{7, 6, 2, 9, 5, 2, 0, 0, 3, 9, 1, 8, 1, 9, 5},
					{3, 2, 5, 2, 5, 8, 6, 7, 7, 2, 2, 9, 4, 1, 9},
